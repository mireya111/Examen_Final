...
router.get('/buscar/estudiantes/:cedula', verificacionToken, verificacionUsuarioAdministrador, BuscarEstudiantePorCedula);
...
router.get('/listado/estudiantes/materias/:cedula', verificacionToken, verificacionUsuarioAdministrador, BuscarEstudianteConSusMaterias);
router.get('/listado/materias/estudiantes/:nombre', verificacionToken, verificacionUsuarioAdministrador, BuscarMateriasYSusEstudiantes);
